...
//		timer.start();
	...
	public void render(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.SPACE)) {
			...
			if (Gdx.input.isKeyPressed(Keys.R)) fruitColor.set(randFruitNum(), Color.RED);

				
				if (Gdx.input.isKeyPressed(Keys.G)) fruitColor.set(randFruitNum(), Color.GREEN);

				
				if (Gdx.input.isKeyPressed(Keys.B)) fruitColor.set(randFruitNum(), Color.CYAN);
				
				if (Gdx.input.isKeyPressed(Keys.Y)) fruitColor.set(randFruitNum(), Color.YELLOW);

				if (Gdx.input.isKeyPressed(Keys.O)) fruitColor.set(randFruitNum(), Color.ORANGE);

				if (Gdx.input.isKeyPressed(Keys.W)) fruitColor.set(randFruitNum(), Color.WHITE);
